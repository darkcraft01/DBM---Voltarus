...
local timerNextCrash		= mod:NewCDTimer(45, 66683, nil, nil, nil, 2, nil, DBM_CORE_L.MYTHIC_ICON)
...
local timerMoltenSpewCD		= mod:NewCDTimer(27, 66820, nil, "Tank", 2, 5, nil, DBM_CORE_L.TANK_ICON)
